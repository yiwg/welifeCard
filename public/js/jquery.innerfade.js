...
(function($) {
    ...
    $.innerfade.next = function(elements, settings, current, last) {
		...
		if(current==0 && settings.autoStop == "yes"){
		  if(settings.endFunction != null){
		    eval(settings.endFunction);
		  }
			var replayDiv = document.createElement('div');
			replayDiv.style.top = ""+settings.replayTop;
			replayDiv.style.right = ""+settings.replayRight;
			replayDiv.style.zIndex = "2000";
      ...
      if(settings.containerId == null){
			  ...
			  document.getElementById(settings.containerId).appendChild(replayDiv);
			}
