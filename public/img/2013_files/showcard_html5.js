/*	var ua = navigator.userAgent.toLowerCase();
	if(ua.match(/MicroMessenger/i)=="micromessenger") {
		...
		window.location.href="http://mp.weixin.qq.com/s?__biz=MjM5NTUwNDA1OA==&mid=200905459&idx=1&sn=3a44e10d6dd827e11fd52b217e28e4cf#rd";
	}
...
{
    var gCardText = '一张小小的卡片，捎去跨星辰对您的无限祝福!';
}

if(typeof(gCardTextNoWrap) == 'undefined')
{
    var gCardTextNoWrap = '一张小小的卡片，捎去跨星辰对您的无限祝福!';
}
...
function goguanzhu()
{
    location.href = 'http://mp.weixin.qq.com/s?__biz=MjM5NTUwNDA1OA==&mid=200905459&idx=1&sn=3a44e10d6dd827e11fd52b217e28e4cf#rd';
}
